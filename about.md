...
My journey with computers began when a neighbour challenged me to write a GW-BASIC program for matrix multiplication after I mentioned learning it in school. That kicked off a lifelong habit of finding the structure in problems and writing programs to solve them.

In my free time I read (mostly fiction), geek out over sports trivia, and try to find the perfect landscape composition.
